...
cutlass-libs:
	...
	@cd zig_src && $(NVCC) $(NVCC_FLAGS) -c cuda_multistream_bench.cu   -o cuda_multistream_bench.o
	@cd zig_src && $(NVCC) $(NVCC_FLAGS) -c cuda_cublaslt_algo_sweep.cu -o cuda_cublaslt_algo_sweep.o
	@cd zig_src && $(NVCC) $(NVCC_FLAGS) -c cuda_nvfp4_fused.cu         -o cuda_nvfp4_fused.o
	...
	@cd zig_src && ar rcs libcutlass_fp8.a         cuda_fp8_cutlass.o cuda_fp16_bench.o cuda_graph_bench.o cuda_fp16_fused_bench.o cuda_nvfp4_emu.o cuda_multistream_bench.o cuda_cublaslt_algo_sweep.o cuda_nvfp4_fused.o nif_linear_swiglu_fp8.o cuda_int_sparse_run.o
