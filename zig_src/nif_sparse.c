...
ERL_NIF_TERM sparse_available(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    (void)argv;
    return cusparselt_available() ? enif_make_atom(env, "true") : enif_make_atom(env, "false");
}
 ...
 */
ERL_NIF_TERM sparse_from_ct16(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    ...
    if (ct16->ndim != 2)
        return make_error(env, "must_be_2d_matrix");
    ...
    SparseTensorInternal *sparse =
        (SparseTensorInternal *)enif_alloc_resource(SPARSE_TENSOR_RESOURCE,
                                                    sizeof(SparseTensorInternal));
    if (!sparse)
...
ERL_NIF_TERM sparse_shape(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    SparseTensorInternal *t = get_sparse_tensor(env, argv[0]);
    if (!t)
        return make_error(env, "invalid_sparse_tensor");

    ERL_NIF_TERM dims[2] = {enif_make_int64(env, t->rows), enif_make_int64(env, t->cols)};
    return make_ok(env, enif_make_list_from_array(env, dims, 2));
}

/** sparse_compression_ratio(SparseTensorRef) -> {ok, Float} */
ERL_NIF_TERM sparse_compression_ratio(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    SparseTensorInternal *t = get_sparse_tensor(env, argv[0]);
    if (!t)
        return make_error(env, "invalid_sparse_tensor");
 ...
 */
ERL_NIF_TERM sparse_matmul_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
 ...
 */
ERL_NIF_TERM sparse_matmul_inplace_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
...
ERL_NIF_TERM sparse_matmul_bench_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
 ...
 * TN layout variant */
ERL_NIF_TERM sparse_matmul_bench_tn_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
 ...
 */
ERL_NIF_TERM sparse_from_int8(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    ...
    if (!ct)
        return make_error(env, "invalid_cuda_int8_tensor");
 ...
 */
ERL_NIF_TERM sparse_matmul_int8_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
...
ERL_NIF_TERM sparse_matmul_int8_inplace_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
...
ERL_NIF_TERM sparse_matmul_int8_bench_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
