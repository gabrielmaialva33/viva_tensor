...
static inline void transpose_tile_fp32(const float *src, float *dst, int rows, int cols, int r0,
                                       int c0, int tile_rows, int tile_cols) {
...
ERL_NIF_TERM nt_transpose_fp32(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
