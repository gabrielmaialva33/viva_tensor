...
static ErlNifFunc nif_funcs[] = {
    ...
    {"nt_fp16_to_fp32_binary", 1, nt_fp16_to_fp32_binary, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    ...
    {"cutlass_fp8_bench", 5, cutlass_fp8_bench_nif, ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"cublaslt_fp16_bench", 4, cublaslt_fp16_bench_nif, ERL_NIF_DIRTY_JOB_IO_BOUND},
    ...
    {"nt_prepack_fp8_blocked", 4, nt_prepack_fp8_blocked, ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"nt_prepack_fp8_blocked", 5, nt_prepack_fp8_blocked, ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"nt_embedding_table_new", 3, nt_embedding_table_new, ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"nt_embedding_table_new_fp16", 3, nt_embedding_table_new_fp16, ERL_NIF_DIRTY_JOB_IO_BOUND},
    ...
    {"nt_forward_decode_step_batched", 10, nt_forward_decode_step_batched,
     ERL_NIF_DIRTY_JOB_IO_BOUND},
    ...
    {"marlin_w4a16_prepack", 7, viva_marlin_w4a16_prepack_nif, ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"marlin_w4a16_get_b_bytes", 1, viva_marlin_w4a16_get_b_bytes_nif, ERL_NIF_DIRTY_JOB_IO_BOUND},
