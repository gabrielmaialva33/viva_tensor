...
CudaInt8Tensor *alloc_cuda_int8_tensor(int ndim, const int *shape) {
    CudaInt8Tensor *t =
        (CudaInt8Tensor *)enif_alloc_resource(CUDA_INT8_TENSOR_RESOURCE, sizeof(CudaInt8Tensor));
    if (!t)
        return NULL;
 ...
 */
ERL_NIF_TERM ct_int8_available(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    (void)argv;
    return cuda_int8_lt_available() ? enif_make_atom(env, "true") : enif_make_atom(env, "false");
}
 ...
 */
ERL_NIF_TERM ct_int8_from_list(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
 ...
 */
ERL_NIF_TERM ct_int8_to_list(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    ...
    if (!t->d_acc)
        return make_error(env, "no_accumulator_data");
...
ERL_NIF_TERM ct_int8_shape(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
 ...
 */
ERL_NIF_TERM ct_int8_matmul(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
 ...
 */
ERL_NIF_TERM ct_int8_matmul_async(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
 ...
 */
ERL_NIF_TERM ct_int8_matmul_inplace_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    CudaInt8Tensor *a = get_cuda_int8_tensor(env, argv[0]);
    CudaInt8Tensor *b = get_cuda_int8_tensor(env, argv[1]);
 ...
 */
ERL_NIF_TERM ct_int8_matmul_bench_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
    (void)argc;
    CudaInt8Tensor *a = get_cuda_int8_tensor(env, argv[0]);
    CudaInt8Tensor *b = get_cuda_int8_tensor(env, argv[1]);
    CudaInt8Tensor *c = get_cuda_int8_tensor(env, argv[2]);
