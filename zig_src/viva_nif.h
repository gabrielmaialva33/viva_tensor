...
extern int cuda_axpy_loop_bench(int n, int iters);
/* Same N kernels captured into a cudaGraph + replayed (no per-launch overhead). */
...
extern ErlNifResourceType *marlin_packed_resource_type;
void marlin_packed_resource_dtor(ErlNifEnv *env, void *obj);
...
NIF_FUNC_DECL(nt_maximum);
NIF_FUNC_DECL(nt_minimum);
NIF_FUNC_DECL(nt_equal);
NIF_FUNC_DECL(nt_not_equal);
NIF_FUNC_DECL(nt_greater);
NIF_FUNC_DECL(nt_greater_equal);
NIF_FUNC_DECL(nt_less);
NIF_FUNC_DECL(nt_less_equal);
NIF_FUNC_DECL(nt_logical_not);
NIF_FUNC_DECL(nt_logical_and);
NIF_FUNC_DECL(nt_logical_or);
NIF_FUNC_DECL(nt_logical_xor);
NIF_FUNC_DECL(nt_where);
...
NIF_FUNC_DECL(block_state_new);
NIF_FUNC_DECL(block_state_free);
...
NIF_FUNC_DECL(viva_marlin_w4a16_prepack_nif);
NIF_FUNC_DECL(viva_marlin_w4a16_get_b_bytes_nif);
