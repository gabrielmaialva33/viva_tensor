...
static const int kScalePerm[64] = {
...
static const int kScalePermSingle[32] = {
  0, 1, 8, 9, 16, 17, 24, 25,
...
)
{
  ...
  if (K <= 0 || N <= 0 || K % 128 != 0 || N % 256 != 0 ||
      effective_groupsize <= 0 || K % effective_groupsize != 0) {
