...
- Be respectful when discussing design, benchmarks, hardware, and trade-offs.
- Keep criticism technical, specific, and actionable.
- Assume contributors may be working across different platforms and levels of hardware access.
- Document surprising behavior, especially around NIFs, CUDA, MKL, numerical precision, and memory ownership.
- Accept responsibility for mistakes and correct them plainly.

Examples of behavior that is not acceptable:

- Harassment, insults, threats, or targeted personal attacks.
- Sexualized language or imagery.
- Trolling, repeated disruption, or bad-faith argument.
- Publishing private information without explicit permission.
- Dismissing safety, security, or correctness concerns without technical review.
